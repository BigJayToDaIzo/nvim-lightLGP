return {
	...
	dependencies = {
		...
		-- Progress indicators that pop up in the bottom right corner
	...
	config = function()
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				-- Helper function for easier keymapping syntax
				local map = function(keys, func, desc)
					vim.keymap.set("n", keys, func, { buffer = event.buf, desc = "LSP: " .. desc })
				end
				-- Keymaps ride in here!
				-- Opens a popup that displays documentation about the word under your cursor
				--  :h K for why this keymap
		...
		local servers = {
			...
			-- pyright = {},
			rust_analyzer = {},
			-- :h lspconfig-all for a list of all the pre-configured LSPs
